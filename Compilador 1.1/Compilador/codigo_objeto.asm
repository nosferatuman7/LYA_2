...
section .data
    ...
    msg3: db "  2.  tiempo = 2.5", 0
    msg4: db "  3.  mensaje = hola mundo", 0
    msg5: db "  4.  func_mover:", 0
    msg6: db "  5.  v = param_v", 0
    msg7: db "  6.  if v <= 0 goto L_sino1", 0
    msg8: db "  7.  print mensaje", 0
    msg9: db "  8.  L_sino1:", 0
    msg10: db "  9.  return", 0
    msg11: db " 10.  param velocidad", 0
    msg12: db " 11.  t1 = call mover, 1", 0
    msg13: db " 12.  halt", 0
    msg14: db "--------------------------------------------------", 0
    msg15: db "Ejecucion del codigo objeto completada.", 0
